/* Eased scroll for wheel/trackpad input, plus smooth anchor-link jumps.
   ...
   - Only wheel input is intercepted and eased. Keyboard scrolling and
     ...
     virtual-scroll rewrite), which risks breaking the sticky orbit section
     (.orbit_sticky, position:sticky over a 300vh .orbit_scroll). Leaving
     them native means there's nothing to break there.
